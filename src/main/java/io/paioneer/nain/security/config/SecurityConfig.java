...
//                        .requestMatchers(HttpMethod.GET, "/staticstical/**", "/report/**", "/usermanager/**", "/adminmanager/**").hasRole("ADMIN")
                        ...
                        .requestMatchers("/api/auth/member", "/login", "/api/notice", "/reissue", "/api/auth/kakao/callback","/api/auth/kakao/signup/callback","/file/view/*","/file/download/*", "/**").permitAll() // 해당 경로들은 인증 없이 접근 가능합니다.
